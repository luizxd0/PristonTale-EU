...
public:
	...
	int					iTextureModifier[8];	//TextureFormState
	int					iAlphaTestDepth;
	...
	BOOL				SetTextureManager( EXETextureManager * pcTextureManager );
	...
	int					HandleVertexLight( void * pRenderBuffer, int iMaterialID, BOOL bClip );
	int					HandleVertex( void * pRenderBuffer, int iMaterialID, BOOL bClip );
	int					HandleVertexNew( void * pRenderBuffer, int iMaterialID, BOOL bClip );
	int					HandleVertexColor( void * pRenderBuffer, int iMaterialID, BOOL bClip, short * psColor );
	...
	static EXEModelCache			* pcModelCache;
