...
class DX::TextureContainer * TextureEngine::Load( std::string strFileName )
{
	...
	if( FAILED( D3DXCreateTextureFromFileExA( DX::Graphic::GetDevice(), strFileName.c_str(), pcTextureContainer->GetWidth(), pcTextureContainer->GetHeight(), 1, 0, D3DFMT_A8B8G8R8, D3DPOOL_MANAGED, D3DX_FILTER_NONE, D3DX_DEFAULT, dwColor, &sImageInfo, NULL, &psTexture ) ) )
	{
		// TODO: Log Error
	}
	return nullptr;
