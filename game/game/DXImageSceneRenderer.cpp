...
void DXImageSceneRenderer::SetNextTexture( DXImageSceneData * ps )
{
	...
	if ( FAILED( D3DXCreateTextureFromFileInMemoryEx( DX::Graphic::GetDevice(), &ps->baData, ps->iSize, SrcInfo.Width, SrcInfo.Height, 1, 0, D3DFMT_A8B8G8R8, D3DPOOL_MANAGED, D3DX_FILTER_NONE, D3DX_DEFAULT, colorkey, &SrcInfo, NULL, &lpTexture ) ) )
	{
