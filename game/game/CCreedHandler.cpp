...
{
	SKILLMANAGERHANDLER->AssaParticle_KeepSkillEffect( "CreedKeep", pcUnitData, 300, SKILLID_Creed );
...
bool CCreedHandler::OnCastAnimationStart( Skill * psSkill )
{
	...
	{
		if ( UNITDATA_HOVER && UNITDATA_HOVER->sCharacterData.iType == CHARACTERTYPE_Player )
			return false;
	}
