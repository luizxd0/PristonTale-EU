...
VertexDeclaration_ptr GraphicsDevice::CreateVertexDeclaration( VertexElements_ptr pVertexElements )
{
	...
	{
		DEBUG( "Could not create Vertex Declaration" );
...
VertexBuffer_ptr GraphicsDevice::CreateStaticVertexBuffer( UINT uElementSize, UINT uElementCount )
{
	...
	{
		DEBUG( "Could not create Vertex Buffer of size %d*%d", uElementSize, uElementCount );
...
IndexBuffer_ptr GraphicsDevice::CreateIndexBuffer( UINT uPrimitiveSize, UINT uPrimitiveCount )
{
	...
	{
		DEBUG( "Could not create Index Buffer of size %d*%d", uPrimitiveSize, uPrimitiveCount );
...
void GraphicsDevice::PopScissorRect()
{
	...
	{
		SAFE_DELETE( vScissorRect[vScissorRect.size() - 1] );
...
BOOL GraphicsDevice::BuildRenderTarget( RenderTarget_ptr pRenderTarget )
{
	...
	{
		DEBUG( "Could not create Render Target Texture" );
	...
	if( FAILED( lpTexture->GetSurfaceLevel( 0, &lpSurface ) ) )
	{
		...
		DEBUG( "Could not create Render Target Surface" );
...
BOOL GraphicsDevice::BuildDepthStencilBuffer( DepthStencilBuffer_ptr pDepthStencilBuffer )
{
	...
	{
		DEBUG( "Could not create Depth Stencil Buffer Surface" );
