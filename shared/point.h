...
public:
	...
	int					  GetPTDistanceXZ( const Point3D * psCompare, int & xz, int & x, int & z ) const;
	int					  GetPTDistanceXZ( const Point3D * psCompare) const;
	int					  GetPTDistanceXZY( const Point3D * psCompare, int & xzy, int& xz, int & x, int & z, int & y ) const;
	int					  GetPTDistanceXZ_Y( const Point3D * psCompare, int & xz, int & y ) const;

	BOOL				  WithinXZYDistance( const Point3D * psCompare, int iDistanceXZY) const;
	BOOL				  WithinXZYDistance( const Point3D * psCompare, int iDistanceXZ, int iDistanceY) const;
